package com.tech.productadderekart
...
import com.tech.productadderekart.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonColorPicker.setOnClickListener {
            Toast.makeText(this, "button picker", Toast.LENGTH_SHORT).show()
            ...
            override fun onMenuItemClick(item: MenuItem?): Boolean {
                if(item?.itemId == R.id.saveProduct){
                    ...
                    if (!productValidation) {
                        Toast.makeText(applicationContext, "Check your inputs", Toast.LENGTH_SHORT).show()
                        return false
                    }
                    saveProduct()
                }
